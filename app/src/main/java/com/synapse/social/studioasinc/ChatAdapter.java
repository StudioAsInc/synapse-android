        ...
        if (holder.my_message_info != null && holder.date != null && holder.message_state != null) {
            ...
            if (showMessageInfo) {
                ...
                if (isMyMessage) {
                    ...
                    holder.message_state.setColorFilter("seen".equals(state) ? com.google.android.material.color.MaterialColors.getColor(_context, com.google.android.material.R.attr.colorPrimary, Color.BLACK) : 0xFF424242, PorterDuff.Mode.SRC_ATOP);
                }
            }
        }
                    ...
                    if (repliedMessagesCache != null && repliedMessagesCache.containsKey(repliedId)) {
                        ...
                        if (snapshot != null && !snapshot.isEmpty()) {
                            ...
                            if (holder.mRepliedMessageLayoutLeftBar != null) {
                                ...
                                leftBarDrawable.setColor(com.google.android.material.color.MaterialColors.getColor(_context, com.google.android.material.R.attr.colorPrimary, Color.BLACK));
