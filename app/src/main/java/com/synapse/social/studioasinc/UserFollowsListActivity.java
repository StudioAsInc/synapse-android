...
public class UserFollowsListActivity extends AppCompatActivity {
	...
	public void _setTab(final double _id) {
		if (_id == 0) {
			_viewGraphics(tab_followers, com.synapse.social.studioasinc.util.ThemeUtils.getThemeColor(UserFollowsListActivity.this, R.attr.colorPrimary), 0xFF3F51B5, 300, 0, Color.TRANSPARENT);
		...
		if (_id == 1) {
			...
			_viewGraphics(tab_followings, com.synapse.social.studioasinc.util.ThemeUtils.getThemeColor(UserFollowsListActivity.this, R.attr.colorPrimary), 0xFF3949AB, 300, 0, Color.TRANSPARENT);
