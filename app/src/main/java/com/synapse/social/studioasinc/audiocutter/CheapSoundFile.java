...
public class CheapSoundFile {
        public interface ProgressListener {
                /**
                 * Will be called by the CheapSoundFile subclass periodically wi
th
                 * values between 0.0 and 1.0. Return true to continue loading t
he file,
                 * and false to cancel.
                 */
        ...
        static HashMap<String, Factory> sExtensionMap = new HashMap<String, Fact
ory>();
        ...
        /**
         * Static method to create the appropriate CheapSoundFile subclass given
 a
         * filename.
         *
        ...
        public static CheapSoundFile create(String fileName,
                        ...
                        throws java.io.FileNotFoundException, java.io.IOExceptio
n {
                ...
                Factory factory = sExtensionMap.get(components[components.length
 - 1]);
                if (factory == null) {
                        return null;
                }
        ...
        public static boolean isFilenameSupported(String filename) {
                ...
                return sExtensionMap.containsKey(components[components.length -
1]);
        }
        ...
        public static String[] getSupportedExtensions() {
                return sSupportedExtensions.toArray(new String[sSupportedExtensi
ons
                                .size()]);
        }
...
n,
        ...
        /**
         * If and only if this particular file format supports seeking directly
into
