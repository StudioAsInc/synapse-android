...
public final class UserFollowersListBinding implements ViewBinding {
  @NonNull
  ...
  private UserFollowersListBinding(@NonNull LinearLayout rootView,
      @NonNull LinearLayout ProfileRelativeUp, @NonNull ImageView badge, @NonNull LinearLayout body,
      @NonNull ImageView genderBadge, @NonNull LinearLayout lin, @NonNull TextView name,
  ...
  @NonNull
  public static UserFollowersListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static UserFollowersListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.user_followers_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static UserFollowersListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new UserFollowersListBinding((LinearLayout) rootView, ProfileRelativeUp, badge, body,
          genderBadge, lin, name, profileAvatar, profileCard, profileCardRelative,
