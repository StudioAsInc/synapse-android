...
public final class ProfileCoverPhotoHistoryBinding implements ViewBinding {
  @NonNull
  ...
  private ProfileCoverPhotoHistoryBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static ProfileCoverPhotoHistoryBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ProfileCoverPhotoHistoryBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.profile_cover_photo_history, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ProfileCoverPhotoHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProfileCoverPhotoHistoryBinding((CoordinatorLayout) rootView, Coordinator, Fab,
          Main, ProfilePhotosHistoryList, back, body, isDataExistsLayout, isDataNotExistsLayout,
