...
public final class SynapseCommentsListCvBinding implements ViewBinding {
  @NonNull
  ...
  private SynapseCommentsListCvBinding(@NonNull LinearLayout rootView, @NonNull ImageView badge,
  ...
  @NonNull
  public static SynapseCommentsListCvBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static SynapseCommentsListCvBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.synapse_comments_list_cv, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static SynapseCommentsListCvBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SynapseCommentsListCvBinding((LinearLayout) rootView, badge, body, btmSpc,
          cmBottom, commentText, commentUnix, genderBadge, hideRepliesListButton, likeCount,
          likeUnlike, likeUnlikeIc, likedByPublisherLayout, likedByPublisherLayoutAvatar,
