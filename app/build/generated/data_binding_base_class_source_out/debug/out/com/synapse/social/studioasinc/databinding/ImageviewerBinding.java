...
public final class ImageviewerBinding implements ViewBinding {
  ...
  private ImageviewerBinding(@NonNull LinearLayout rootView, @NonNull WebView image) {
  ...
  public static ImageviewerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.imageviewer, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static ImageviewerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.image;
      WebView image = ViewBindings.findChildViewById(rootView, id);
      if (image == null) {
        break missingId;
      }

      return new ImageviewerBinding((LinearLayout) rootView, image);
    }
