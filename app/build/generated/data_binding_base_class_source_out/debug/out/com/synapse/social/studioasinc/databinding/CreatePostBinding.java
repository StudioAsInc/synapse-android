...
public final class CreatePostBinding implements ViewBinding {
  ...
  private CreatePostBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout Main,
      ...
      @NonNull Button postButton, @NonNull FadeEditText postDescription,
      @NonNull ImageView postImageView, @NonNull ScrollView scroll,
      @NonNull LinearLayout scrollBody, @NonNull LinearLayout settingsButton,
      @NonNull LinearLayout spc2, @NonNull TextView title, @NonNull LinearLayout top,
  ...
  @NonNull
  public static CreatePostBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CreatePostBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.create_post, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CreatePostBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CreatePostBinding((LinearLayout) rootView, Main, PostInfoTop1, back, imageCard,
          imagePlaceholder, main, postButton, postDescription, postImageView, scroll, scrollBody,
          settingsButton, spc2, title, top, topSpace, topSpace2, topSpc);
    }
