...
public abstract class Hilt_InboxCallsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InboxCallsFragment() {
    super();
  }

  Hilt_InboxCallsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InboxCallsFragment_GeneratedInjector) this.generatedComponent()).injectInboxCallsFragment(UnsafeCasts.<InboxCallsFragment>unsafeCast(this));
    }
  }
