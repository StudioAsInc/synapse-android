...
public abstract class Hilt_InboxChatsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InboxChatsFragment() {
    super();
  }

  Hilt_InboxChatsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InboxChatsFragment_GeneratedInjector) this.generatedComponent()).injectInboxChatsFragment(UnsafeCasts.<InboxChatsFragment>unsafeCast(this));
    }
  }
