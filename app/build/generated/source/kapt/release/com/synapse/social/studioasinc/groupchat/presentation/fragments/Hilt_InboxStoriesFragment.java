...
public abstract class Hilt_InboxStoriesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_InboxStoriesFragment() {
    super();
  }

  Hilt_InboxStoriesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((InboxStoriesFragment_GeneratedInjector) this.generatedComponent()).injectInboxStoriesFragment(UnsafeCasts.<InboxStoriesFragment>unsafeCast(this));
    }
  }
